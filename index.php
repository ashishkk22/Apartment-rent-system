  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-heading text-uppercase">Welcome To Home Rental Registration!<br></div>
        </div>
      </div>
    </header>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright"> &copy; AVJ'S WEBSITE 2021</span>
          </div>
          <div class="col-md-4">
